...
if ($count == 0) {
    $projects = [
        ['BenStore',          'Développement Web',  'Boutique e-commerce complète avec système de paiement et gestion des stocks.',    '["PHP","MySQL","Bootstrap","JavaScript"]', 'assets/img/BenStore.PNG',       'https://benstore.iceiy.com',           'published'],
        ['Allianz',           'Design Graphique',   'Refonte visuelle et identité de marque pour une agence de services.',             '["Figma","Photoshop","UI/UX"]',            'assets/img/Allianz.PNG',        'https://allianzgroup.iceiy.com',        'published'],
        ['Tesla Landing Page','Développement Web',  "Page d'atterrissage moderne et responsive inspirée du design Tesla.",             '["HTML","CSS","JavaScript","Responsive"]', 'assets/img/Tesla.PNG',          'https://teslausa.iceiy.com/index.php', 'published'],
        ['Sourire de Pâques', 'Design Graphique',   'Campagne visuelle festive pour un événement saisonnier.',                         '["Figma","Design Graphique"]',             'assets/img/SourirePaques.PNG',  'https://sourirepaques.iceiy.com',       'published'],
    ];
